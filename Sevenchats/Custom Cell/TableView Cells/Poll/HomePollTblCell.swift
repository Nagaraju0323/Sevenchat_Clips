            ...
            if response != nil {
                GCDMainThread.async { [self] in
                    ...
                    if self?.notifcationIsSlected == true{
                        MIGeneralsAPI.shared().sendNotification(self?.posted_ID, userID: user_ID, subject: "liked your Post Poll", MsgType: "COMMENT", MsgSent: "", showDisplayContent: "liked your Post Poll", senderName: firstName + lassName)
