...
//                let postuserid = postInfo[""]
                ...
                if self?.notifcationIsSlected == true{
                    ...
                    MIGeneralsAPI.shared().sendNotification(self?.posted_ID, userID: user_ID, subject: "liked your Post Article", MsgType: "COMMENT", MsgSent: "", showDisplayContent: "liked your Post Article", senderName: firstName + lassName)
