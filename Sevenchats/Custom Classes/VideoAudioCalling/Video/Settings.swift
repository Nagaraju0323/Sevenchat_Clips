...
class Settings: NSObject {
    ...
    let supportedAudioCodecs: [TwilioVideo.AudioCodec] = [
        IsacCodec(),
        OpusCodec(),
        PcmaCodec(),
        PcmuCodec(),
    ...
    let supportedVideoCodecs: [VideoCodec] = [
        Vp8Codec(),
    ...
    let supportedSignalingRegions: [String] = [
        "gll",
        "au1",
        "br1",
        "de1",
    ...
    let supportedSignalingRegionDisplayString: [String : String] = [
