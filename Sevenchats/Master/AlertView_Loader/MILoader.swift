...
//  Swifty_Master
//
//  Created by Mac-0002 on 12/09/17.
...
extension MILoader {
    ...
    func setActivityIndicatorStyle(style:UIActivityIndicatorView.Style) {
        MILoader.activityIndicator.style = style
    }
...
extension MILoader {
    ...
    func setLblMessageText(message:String?) {
...
extension MILoader {
    ...
    fileprivate static let firstLayer:CAShapeLayer = {
        ...
        firstLayer.strokeColor = ColorAppTheme.cgColor
    ...
    fileprivate static let secondLayer:CAShapeLayer = {
        ...
        secondLayer.strokeColor = ColorAppTheme.cgColor
...
extension MILoader {
    ...
    fileprivate func showActivityIndicator() {
        if !appDelegate.window.subviews.contains(MILoader.activityIndicator) {
...
extension MILoader {
    ...
    fileprivate func showActivityIndicatorWithMessage(message:String?) {
        ...
        if !appDelegate.window.subviews.contains(MILoader.transparentOverlayView) {
