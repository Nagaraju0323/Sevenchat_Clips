...
typealias BlockDidScrollViewDelegate    = (_ scrollView:UIScrollView?) -> (Void)
...
{
    lazy var blockDidScrollViewDelegate:BlockDidScrollViewDelegate? = nil
...
//            print("::::::::::sectionName\(section?.name)")
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath){
        NotificationCenter.default.post(name: NSNotification.Name(rawValue: "DidSelectCLK"), object: nil, userInfo: ["index":indexPath])
    ...
    {
        NotificationCenter.default.post(name: NSNotification.Name(rawValue: "DidDisSelectCLk"), object: nil,userInfo: ["index": indexPath])
    ...
    {
        NotificationCenter.default.post(name: NSNotification.Name(rawValue: "SwipeReplyCLK"), object: nil,userInfo: ["index": indexPath])
    ...
    func scrollViewDidScroll(_ scrollView: UIScrollView) {
        ...
        if (self.blockDidScrollViewDelegate != nil)
        {
            self.blockDidScrollViewDelegate!(scrollView)
        }
    }
