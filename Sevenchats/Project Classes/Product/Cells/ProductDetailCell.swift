...
//                    self.likeCount = self.btnLike.isSelected ? self.likeCount + 1 : self.likeCount - 1
                    ...
                    if self?.notifcationIsSlected == true{
                        ...
                        MIGeneralsAPI.shared().sendNotification(self?.modelData.productUserID, userID: user_ID, subject: "liked your Product", MsgType: "COMMENT", MsgSent: "", showDisplayContent: "liked your Product", senderName: firstName + lassName)
