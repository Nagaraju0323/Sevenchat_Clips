                                ...
                                if userSelectType == 2 {
                                    ...
                                    strArr.forEach { friends_ID in
                                        if friends_ID == user_ID.description{
                                            ...
                                            MIGeneralsAPI.shared().sendNotification(friends_ID, userID: user_ID.description, subject: "has left from the group\(self.strGroupName)", MsgType: "GROUP_REMOVE", MsgSent:"", showDisplayContent: "has left from the group\(self.strGroupName)", senderName: self.strGroupName, post_ID: [:],shareLink: "sendGrpExitLink")
                                        }
                                    }
                                }
                                if userSelectType == 1{
                                    ...
                                    strArr.forEach { friends_ID in
                                        if friends_ID == user_ID.description{
                                            ...
                                            MIGeneralsAPI.shared().sendNotification(friends_ID, userID: user_ID.description, subject: "has deleted the group \(self.strGroupName)", MsgType: "GROUP_REMOVE", MsgSent:"", showDisplayContent: "has deleted the group\(self.strGroupName)", senderName: self.strGroupName, post_ID: [:],shareLink: "sendGrpDeleteLink")
                                        }
                                    }
